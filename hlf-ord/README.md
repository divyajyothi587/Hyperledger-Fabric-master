...
```bash
$ helm install ar-repo/hlf-ord --name ord1
```
...
```bash
$ helm install ar-repo/hlf-ord --name ord1 --set ord.mspID=MyMSP
```

Alternatively, a YAML file can be provided while installing the chart. This file specifies values to override those provided in the default values.yaml. For example,

```bash
$ helm install ar-repo/hlf-ord --name ord1 -f my-values.yaml
```
...
```bash
$ helm upgrade ord1 ar-repo/hlf-ord -f my-values.yaml
```
